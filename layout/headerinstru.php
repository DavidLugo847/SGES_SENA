			...
			<a class="bordes" href="memberpage.php" title="Sistema de Gestionamiento de Egresados del SENA">SGES</a>
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="memberpage.php" class="hvr-underline-from-center scroll MA">Inicio</i> </a></li>   
                            <li><a href="memberpage.php?id=<?php echo $_SESSION['UsId'];?>&accion=infoperson" class="hvr-underline-from-center scroll MA"><span class="icon-house"></span><center>Inf. Personal</center></a></li>                         
							<li><a href="memberpage.php?id=<?php echo $_SESSION['UsId'];?>&accion=infocount" class="hvr-underline-from-center scroll MA">Inf. Cuenta</a></li>                            
...
<header>
    ...
    <li><a href="memberpage.php?accion=egresados"><span class="icon-suitcase"></span>Egresados</a></li>
