...
<div class="container">
	...
	<div class="row">
                ...
                <h2>Estudios: <?php echo $Nombres;?> <?php echo $Apellidos;?></h2>
                              	<hr>
                                <a href="memberpage.php?id=<?php echo $id ?>&accion=addestudios" class="btn btn-danger btn-lg btn-block"><h4>Agregar Estudios</h4></a>
				...
				$query=mysqli_query($mysqli,$sql);
				 while($arreglo=mysqli_fetch_array($query)){
				  	echo "<tr class='success'>";
                        ...
                        echo "<td class='verde'><a href='memberpage.php?EstId=$arreglo[0]&accion=editestudos'><center><span class='icon-pencil'></span></a></td>";
