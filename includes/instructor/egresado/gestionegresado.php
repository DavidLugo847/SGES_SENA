...
<div class="container">
	...
	<div class="row">
                                ...
                                <h2>Gestionar Egresados</h2>
                              	<hr>
                                <a href="memberpage.php?accion=addegresado" class="btn btn-danger btn-lg btn-block"><h4>Agregar Egresado</h4></a>
                                ...
                                <br>
                                    <?php $sql=("SELECT * FROM egresado");
                                            ...
                                            <a href="memberpage.php?id=<?php echo $EgId?>&accion=infoegresado">
                                            ...
                                            <a href="memberpage.php?id=<?php echo $EgId;?>&accion=gestionestudios" class="boton-blanco"><div class="botonestudio">
                                                Gestionar Estudios <br> <center><span class="icon-file-text2"></span></center>
                                            </div></a>
                                            <div class="botonesEA">
                                            <a href="memberpage.php?id=<?php echo $EgId;?>&accion=aEg"><div class="botonA"><span class="icon-pencil"></div></span></a>
				...
				<h2>Gestionar Egresados</h2>
                                ...
                                <br><table border="1" class="table-gestion">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="memberpage.php?id=<?php echo $UsersAdmin->getEgid();?>&accion=infoegresado">Mostrar</a></td>
                                        <td><a href="memberpage.php?id=<?php echo $UsersAdmin->getEgid()?>&accion=aEg">Editar</a></td>
