...
require_once('includes/actu.php');
...
<section class="form_wrap">
        ...
        <tr>
                 ...
                 <td><?php echo '' .round($promedio,1); ?>
                     <input type="hidden" name="promedio" value="<?php echo $promedio;?>">
                     <input type="hidden" name="idEg" value="<?php echo $idEg;?>">
                 </td>
                ...
                <table>
                    <tr>
                        ...
                        <td><input type="submit" name="actcal" value="Confirmar" id="btnSend"></td>
                </tr>
                </table>
 <?php }
                 else {?>
