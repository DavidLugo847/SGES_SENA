...
<div class="container">
	...
	<div class="row">
				...
				<h2>Gestionar Hojas de vida</h2>
                              	<hr>
                                <a href="memberpage.php?accion=addhoja" class="btn btn-danger btn-lg btn-block"><h4>Agregar hoja de vida</h4></a>
                                <br>
                            <?php 
				...
				while($arreglo=mysqli_fetch_array($query)){
                               ...
                               ?>
                                ...
                                <a href="memberpage.php?id=<?php echo $EstId?>&accion=mhoja">
                                ...
                                <div class="botoncal">
                                  ...
                                  <div class="resto-cal">
                                  <a href="memberpage.php?id=<?php echo $arreglo[1];?>&accion=calhv"><div class="botones-cal">Add<br> calificación</div></a>
                                  <a href="memberpage.php?id=<?php echo $arreglo[1];?>&accion=vercal"><div class="botones-cal">Ver<br> calificaciones</div></a>
                                  </div>
                                </div>
                                <div class="botonesEA">
                                <a href="memberpage.php?id=<?php echo $arreglo[1];?>&accion=edithoja"><div class="botonA"><span class="icon-pencil"></div></span></a>
                                <a href="memberpage.php?id=<?php echo $arreglo[0];?>&accion=delatehoja"><div class="botonE"><span class="icon-trash"></div></span></a>
                                </div>
                                </div> 
                                <?php  }?>  
