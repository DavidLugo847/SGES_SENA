	    ...
	    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
			<form  method="post" action="" autocomplete="off">
				...
				<div class="form-group">
                                    ...
                                    <h6>Contraseña</h6>
                                    <input type="text" name="pass" id="password" class="form-control input-lg" placeholder="Password" tabindex="3" value="<?php echo $passadmin; ?>" readonly>

                                </div>
	
				<hr>
				<div class="form-group">
                                    <a href="adminpage.php?id=<?php echo $_SESSION['UsId'];?>&accion=aAdmin" class="btn btn-primary btn-lg btn-block ">Editar Información</a>
                                </div>   				
