...
$Estid=$_GET['EstId'];
require('includes/mostrar/mostraractuestudios.php');
$id=$EstEgresado;
...
<section class="form_wrap">
        ...
        <form id="frmregistro" class="form_contact" method="post" enctype="multipart/form-data">
            ...
            <div class="user_info">
                        ...
                        <table>
                            <input type="hidden" name="id" value="<?php echo $Estid; ?>">
                    <tr>
                    ...
                    <tr>
                        ...
                        <input type="text" name="nombrecurso" id="nombreaprendiz" value="<?php echo $EstName; ?>"></td>                        
                    </tr>                 
                    </tr>
                    <tr>
                        <td><label for="fechainicio">Fecha de inicio de la formación</label>
                        <input type="date" name="fechainicio" id=documento" value="<?php echo $EstAnioI; ?>"></td>                        
                    </tr>
                    <tr><td colspan="2"><div id="aprendiz"></div></td>
                    <tr>
                        <td><label for="fechafinal">Fecha de graduación</label>
                        <input type="date" name="fechafinal" id=documento" value="<?php echo $EstAnioF; ?>"></td>
                    <tr>
                        <td><label for="sedegradu">Sede de graduación</label>
                        <input type="text" name="sedegradu" id="ciudadaprendiz" value="<?php echo $EstLugarG; ?>"></td>
                    </tr>
