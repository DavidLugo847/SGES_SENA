...
<?php
$title = 'Members Page';
require('layout/headueruser.php'); 
?>
<head>
    <meta charset="utf-8">
			...
			<form  method="post" action="" autocomplete="off">
				...
				<div class="row">
					<div class="col-xs-6 col-sm-6 col-md-6">
						<div class="form-group">
                                                        <h6>Contraseña</h6>
							<input type="text" name="pasadmin" id="password" class="form-control input-lg" placeholder="Password" tabindex="3" value="<?php echo $pasadmin; ?>" required>
						</div>
					</div>
					<div class="col-xs-6 col-sm-6 col-md-6">
						<div class="form-group">
				...
				<hr>
				<div class="row">
                                    <div class="col-xs-6 col-md-6"><input  class="btn btn-primary btn-block btn-lg" type="submit" name="submit" value="Actualizar" tabindex="5"></div>					
				</div>
			</form>
		</div>
	</div>
